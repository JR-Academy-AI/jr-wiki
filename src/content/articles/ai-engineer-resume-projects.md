---
title: "AI Engineer 简历的项目部分：写六个不如写透两个"
description: "两个能被追问十分钟的项目，胜过六个只撑三十秒的。给三段式 bullet 模板（约束 → 决策 → 可验证结果）、六个必须答得上的追问、三种直接判死的写法，以及澳洲本地的三个差异。"
...
tags:
  ...
  - resume
author: "JR Academy"
keywords: "AI Engineer简历, 简历项目经历怎么写, AI工程师作品集, 澳洲求职简历, 技术面试"
---
...
- 📖 同主题延伸：[为什么 AI 课程学完依然找不到工作](/blog/ai-course-to-job-gap)
